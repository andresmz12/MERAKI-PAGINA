      ...
      >
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 font-sans text-sm text-white/50">
            ...
            <span>/</span>
            <Link href="/propiedades" className="hover:text-[#D4AF37] transition-colors">Propiedades</Link>
            <span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <span className="font-sans bg-[#1A1A2E]/10 text-[#1A1A2E] text-xs font-semibold px-3 py-1.5 capitalize">
                  {prop.tipo}
                </span>
              </div>

              <h1 className="font-display text-[#1A1A2E] font-semibold mb-3" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.5rem)' }}>
                {prop.titulo}
              </h1>
            ...
            {stats.length > 0 && (
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
                {stats.map((stat) => stat && (
                  <div key={stat.label} className="bg-white p-4 text-center shadow-sm border-b-2 border-[#D4AF37]">
                    <div className="text-2xl mb-1">{stat.icon}</div>
                    <div className="font-display text-[#1A1A2E] text-lg font-semibold leading-tight">{stat.value}</div>
            ...
            <div className="bg-white p-8 shadow-sm">
              <h2 className="font-display text-[#1A1A2E] text-2xl font-semibold mb-1">Descripción</h2>
            ...
            {prop.caracteristicas.length > 0 && (
              <div className="bg-white p-8 shadow-sm">
                <h2 className="font-display text-[#1A1A2E] text-2xl font-semibold mb-1">Características</h2>
                <div className="w-8 h-0.5 bg-[#D4AF37] mb-5" />
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {prop.caracteristicas.map((c) => (
                    <div key={c} className="flex items-center gap-2.5 font-sans text-sm text-[#2C2C3E]">
                      <div className="w-5 h-5 bg-[#D4AF37] flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#1A1A2E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            <div className="bg-[#1A1A2E] p-8 sticky top-24">
              <p className="font-sans text-[#D4AF37] text-xs tracking-[0.3em] uppercase mb-2">
              ...
              <div className="border-t border-white/10 mt-6 pt-6 space-y-3">
                <a
                  ...
                  className="w-full font-sans bg-[#D4AF37] text-[#1A1A2E] py-3.5 text-sm font-bold tracking-widest uppercase text-center flex items-center justify-center gap-2 hover:bg-[#c9a52f] transition-colors"
                >
                ...
                <a
                  ...
                  className="w-full font-sans border border-white/20 text-white py-3.5 text-sm font-semibold tracking-widest uppercase text-center flex items-center justify-center gap-2 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-colors"
                >
        ...
        {similares.length > 0 && (
          <div className="mt-20">
            <div className="flex flex-col items-center mb-10 text-center">
              ...
              <h2 className="font-display text-[#1A1A2E] text-3xl font-light">
              ...
              {similares.map((prop) => (
                <div key={prop.id}>
                  ...
                  <Link href={`/propiedades/${prop.slug}`} className="group block bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="p-5">
                      <p className="font-display text-[#D4AF37] text-xl font-semibold mb-1">
                        {formatPrice(prop.precio, prop.moneda)}
                      </p>
